            ...
            <div class="card card-3">
                ...
                <div class="card-body">
					...
					<div class="input-group">
                            <input class="input--style-3" type="number" placeholder="Id" name="id" required>
                      </div>
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            <input class="input--style-3 js-datepicker" type="text" placeholder="Birthdate" name="dob"required>
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Phone" name="num"required>
                        </div>
						<div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Address" name="add"required>
                        </div>
						<div class="input-group">
                            <input class="input--style-3" type="text" placeholder="City" name="city"required>
                        </div>
						<div class="input-group">
                            <input class="input--style-3" type="number" placeholder="Pincode" name="pin"required>
                        </div>
						<div class="input-group">
